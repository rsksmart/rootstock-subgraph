...
npx mustache config/RSK.testnet.json src/contracts/contracts.template > src/contracts/contracts.ts;
echo "File: ${green}src/contracts/contracts.ts${reset} has been mustached";
npx mustache config/RSK.testnet.json src/blockNumbers/blockNumbers.template.ts > src/blockNumbers/blockNumbers.ts;
