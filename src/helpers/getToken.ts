...
import { ERC20Token as ERC20TokenContract } from '../../generated/templates/ERC20Token/ERC20Token'

export function getToken(tokenAddress: Address, converterAddress: Address, smartTokenAddress: Address): Token {
